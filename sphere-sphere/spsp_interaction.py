...
def contribution_finite(R1, R2, L, K, n_sphere1, n_sphere2, Nouter, Ninner, M, nds, wts, lmax, nproc, observable):
    r"""
...
def contribution_zero(R, L, alpha_plane, alpha_sphere, materialclass_plane, materialclass_sphere, N, M, nds, wts, lmax, nproc, observable):
    ...
    ## TE contribution
    rTE = np.array([rTE_finite(K, k, alpha_plane) for k in nds])
