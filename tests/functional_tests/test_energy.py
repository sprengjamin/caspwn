...
ref = np.loadtxt("reference_data/caspwn/data01.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data02.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data03.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data04.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data05.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data06.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data07.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data08.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data09.out")
...
s.automatic_integration = False
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data10.out")
...
s.automatic_integration = False
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data11.out")
...
s.automatic_integration = False
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data12.out")
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data13.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data14.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data15.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data16.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data17.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data18.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data19.out")[0]
...
res = s.calculate('energy')
ref = np.loadtxt("reference_data/caspwn/data20.out")[0]
