...
from PFA import PFA
#data0 = np.loadtxt("energy_PS1_Water_Silica1_v6.dat").T
data1 = np.loadtxt("energy_PS1_Water_Silica1_v6.dat").T
...
ax.loglog(data1[0, 1:-1], rel[1:-1], label="with $n=0$")
ax.loglog(data1[0, 1:-1], rel2[1:-1], label="without $n=0$")
