...
from energy import energy_finite, make_phiSequence
...
filename = "energy_"+materials[0]+"_"+materials[1]+"_"+materials[2]+".dat"
...
if not os.path.isfile(filename):
    ...
    for L in Lvals:
        ...
        M = N
        start = time.time()
        en = energy_finite(R1, R2, L, T, materials, N, M, nproc)
        end = time.time()
        t = end-start
        f=open(filename, "ab")
        np.savetxt(f, [[L, en, t]])
